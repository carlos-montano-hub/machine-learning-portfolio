...
# docker exec -it flink-sql-client bash -lc "cat /opt/flink/sql/setup_flink.sql <(echo '') /opt/flink/sql/source_sink_flink_tables/dim_time.sql > /tmp/combined.sql && bin/sql-client.sh -f /tmp/combined.sql"
